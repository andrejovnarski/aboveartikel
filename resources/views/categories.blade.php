...
<div class="w-5/6 mx-auto">
    ...
    <div class="flex my-12 text-center">
        <div>
            <div class="text-center my-12 font-bold text-6xl uppercase">{{$category->category}}</div>
            @foreach ($blogs as $blog)
            <a href="{{route('welcome.blogs.show', $blog->id)}}" class="w-1/3 mx-6">
                <div class="flex mb-6">
                        <img src="/images/{{$blog->image}}" alt="" width="400" height="300">
                        <div class="mx-6 text-left align-center">
                            ...
                            <p class="my-6">{{Str::limit($blog->story, 700)}}</p>
                        </div>
                    </div> 
                </a>
            @endforeach
